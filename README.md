...
<script type="text/javascript">
    ...
    ga('require', 'displayfeatures');/* no referer (); */    ga('set', 'anonymizeIp', true);
    ...
    ga('set', 'dimension58', 'exp_recommendationtop_control');
    ...
    <script>
        ...
        (function(h,o,t,j,a,r){           
            ...
            h._hjSettings={hjid:1180136,hjsv:6};
...
<body class="logged-out">
    ...
    <template id="premium-promo-modal" class="modalWrapper">
...
</template>    <template id="premium-covid-expired-modal" class="modalWrapper">
